...
<div class="space-90"></div>
	...
	<form action="efetuado.php" method="get">
			<input class="form-control" type="hidden"  id="valoremprestimo"   name="valoremprestimo"    value="<?php echo $_GET['valoremprestimo'];?>"  >
			<input class="form-control" type="hidden"  id="optionsCheckboxes" name="optionsCheckboxes"  value="<?php echo $_GET['optionsCheckboxes'];?>"  >
			<input class="form-control" type="hidden"  id="juros"             name="juros" 				value="<?php echo $_GET['juros'];?>"  >
			<h3 class=" label-success" style="color:#fff; border-radius:20px ">CONFIRMAÇÃO DE EMPRÉSTIMO</h3>

			<h4 class=" " style="border-radius:20px ">Confirme o Seu CNPJ:</h4>
			<input class="form-control" type="text" data-mask="00.000.000/0000-00"  v-model="cnpj" id="cnpj" name="cnpj"  required>

			<h4 class=" " style="border-radius:20px ">Confirme o Seu EMAIL:</h4>
			<input class="form-control" type="email" v-model="email" id="email" name="email"  required>

			<button   id="solicitar"  class="btn btn-success" > CONFIRMAR </button>
	</form>
